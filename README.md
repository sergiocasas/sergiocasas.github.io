...
- `hugo` to create the public folder
- `hugo new --kind publication publication/$PUBLICATION_NAME` to add a new publication
- `scp -r public/* sergio@cs.toronto.edu:/cs/htuser/sergio/public_html/` to deploy website into UofT's server
___
